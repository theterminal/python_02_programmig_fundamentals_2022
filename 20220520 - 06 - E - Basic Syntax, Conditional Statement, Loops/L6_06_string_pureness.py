...
# ----------------- version 4 --------------------
# This version is OK if there are many symbols to check within a string.
...
# ----------------- version 3 --------------------
# This version is OK if you have to check only few symbols
...
# ----------------- version 2 --------------------
# It goes only through the first special character, and it breaks!
